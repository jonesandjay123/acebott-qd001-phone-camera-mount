...
- File: `models/current/ACEBOTT_QD001_PhoneMount_V6_90deg_OnePiece.stl`
...
- Supports: **off**. Every overhang is ≤ 45° or a bridge that already printed fine on V4
  (42 mm battery-bay roof, 41 mm left gable, 34 mm mast arch, 32 mm USB‑C window, 23 mm tie band).
...
- Material: PLA/PLA+ or PETG. ~107 g PLA estimated. Time roughly 2.5–4 h at 0.28 mm (about 0.6× the V4 print).

## What to check after printing
1. Phone slides in from the top and sits on the two floor pads; USB‑C plug fits through the centre gap.
2. Battery still slides out sideways under the arches.
3. DC plug / cable pass through the left-side window.
4. If the phone rattles at the lips (6.5 mm play at 90°), add a 1–2 mm felt/foam strip on the plate,
